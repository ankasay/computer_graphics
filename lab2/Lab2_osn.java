...
public class Lab2_osn {
    ...
    public static void main(String[] args) {
        ...
        Mat im1 = loadImage("C:\\Users\\1\\IdeaProjects\\lab_2_CG\\im_1.png");
        Mat im2 = toMonochrome(loadImage("C:\\Users\\1\\IdeaProjects\\lab_2_CG\\im_2.png"));



        // Применение дитеринга Флойда-Стейнберга
        for (int i = 1; i <= 5; i++) {
            Mat Img1 = applyFloydSteinbergDithering(im1, i);
            saveImage(Img1, "C:\\Users\\1\\IdeaProjects\\lab_2_CG\\floyd_im_1_" + i + "bpp.png");


            Mat Img2 = applyFloydSteinbergDithering(im2, i);
            saveImage(Img2, "C:\\Users\\1\\IdeaProjects\\lab_2_CG\\floyd_grey_im_2_" + i + "bpp.png");
